...
class FeishuRequest:
    ...
    def write_document(self, document_id:str, content: str, position: str="start") -> dict:
        url = f"https://lark-plugin-api.solutionsuite.cn/lark-plugin/document/create_document"
        payload = {
    ...
    def get_document_raw_content(self, document_id: str) -> dict:
        ...
        url = f"https://lark-plugin-api.solutionsuite.cn/lark-plugin/document/get_document_raw_content"
    ...
    def list_document_block(self, document_id: str, page_token:str, page_size: int=500) -> dict:
        ...
        """
        url = f"https://lark-plugin-api.solutionsuite.cn/lark-plugin/document/list_document_block"
        params = {
            "document_id": document_id,
            "page_size": page_size,
